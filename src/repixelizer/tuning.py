...
def _row_score(row: dict[str, Any]) -> float:
    ...
    return error_ratio * 0.50 + adjacency_ratio * 0.25 + motif_ratio * 0.25
...
def tune_solver_hyperparams(
    ...
    *,
    ...
    payload = {
        ...
        "objective": "0.5 * error_ratio_to_naive + 0.25 * adjacency_ratio_to_naive + 0.25 * motif_ratio_to_naive; lower is better",
